            ...
            <div className="navbar">
                <div className="navbar-start">
                    ...
                    <div className="flex gap-2 items-center ">
                        <img className=" md:block lg:block h-16 lg:w-44 p-2 rounded-lg" src={logo1} alt="" />
                ...
                <div className="navbar-end">
                    {user ? (
                        <p className="truncate text-base font-bold text-black hidden lg:block pe-3 md:block">
                            {user?.displayName}
                        </p>
                    ) : (
                        ""
